...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pretrained_model_name_or_path", type=str, default=DEFAULT_SD14_MODEL_ID,
    ...
    parser.add_argument("--finetuning_method", type=str, default="xattn",
        choices=["full", "selfattn", "xattn", "noxattn", "notime", "selfattn+xattn", "k+v", "xattn_out"])
...
def sample_until(
    ...
    for i, t in enumerate(timesteps):
       ...
       # print("强制指定到devices[0] prompt_embeds的设备:", prompt_embeds.device)
        ...
        noise_pred = unet(latent_model_input.to(devices[0]), t, encoder_hidden_states=prompt_embeds.to(devices[0])).sample
