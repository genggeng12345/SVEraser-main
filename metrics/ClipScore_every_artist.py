...
def parse_args():
    parser = argparse.ArgumentParser(
        prog="CLIPScoreEveryArtist",
        description="Compute CLIPScore and report the mean for each artist.",
    )
    parser.add_argument("--img_path", type=str, required=True, help="Path to generated images.")
    parser.add_argument("--prompts_path", type=str, required=True, help="CSV with case_number and artist columns.")
